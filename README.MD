...
docker build -f ./backend/Dockerfile.prod --build-arg PROJECT_NAME=MyRelationshipApp.API --build-arg ASPNETCORE_ENVIRONMENT=Production --build-arg ASPNETCORE_URL="http://+:8080"  -t my-backend-api ./backend
